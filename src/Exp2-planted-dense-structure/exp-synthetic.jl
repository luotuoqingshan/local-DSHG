...
ϵs = [1.0, 0.3, 0.8, 0.8] 
penaltyTypes = ["fracvol", "vol", "WCE", "UCE"]
...
# Plot
ϵs = [1.0, 0.3, 0.8] 
penaltyTypes = ["fracvol", "vol", "WCE"]
penaltyLabels = ["FracVol", "Vol", "WCE"]
colors = [:red, :blue, :green]
fig = Figure(figure_padding=1.5, resolution=(400,200))
axis = Axis(fig[1,1], xticklabelpad=-25, yticklabelpad=-35, 
...
axis.xticks = 0.0:0.25:1.0
axis.yticks = 0.0:0.2:0.8
axislegend(axis, position=(0.2, 0.2), merge = true, unique = true)
save(homedir()*"/local-DHSG/figs/HSBM/f1score-comparison.pdf", fig, pt_per_unit=1)